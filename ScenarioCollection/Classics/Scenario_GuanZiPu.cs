...
namespace ScenarioCollection
{
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        ...
        public Game Scenario_GuanZiPu_A2Q28_101Weiqi()
        {
            ...
            gi.solutionPoints.Add(new List<Point>() { new Point(0, 14), new Point(0, 15), new Point(2, 18), new Point(1, 18), new Point(0, 17) });
 ...
 18 . . X . . . . . . . . . . . . . . . .
        ...
        {
            //https://www.101weiqi.com/q/19011/
            var gi = new GameInfo(SurviveOrKill.Kill, Content.White);
            var g = new Game(gi);
 ...
 18 . . O X X . . . . . . . . . . . . . .
        ...
        {
            //https://www.101weiqi.com/q/38614/
            var gi = new GameInfo(SurviveOrKill.Kill, Content.White);
            var g = new Game(gi);
