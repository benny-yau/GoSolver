...
namespace Go
{
    ...
    public class SolutionHelper
    {
        ...
        {
            Point? solutionMove = GetSolutionMove(g);
        ...
        /// </summary>
        public static Point? GetSolutionMove(Game m)
        {
        ...
        /// </summary>
        public static ConfirmAliveResult CheckSolutionComplete(Game m)
        {
            List<List<Point>> solutions = m.GameInfo.CombinedSolutions.Where(s => s.Count == m.Board.LastMoves.Count).ToList();
            int? solutionIndex = FollowedSolution(solutions, m.Board.LastMoves).FirstOrDefault();
            if (solutionIndex == null)
            ...
            else
            {
                ...
                {
                    if (m.GameInfo.UserFirst == PlayerOrComputer.Computer)
